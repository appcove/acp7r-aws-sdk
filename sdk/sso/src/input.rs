...
#[doc(hidden)] pub type GetRoleCredentialsInputOperationOutputAlias = crate::operation::GetRoleCredentials;
            #[doc(hidden)] pub type GetRoleCredentialsInputOperationRetryAlias = aws_http::retry::AwsErrorRetryPolicy;
impl GetRoleCredentialsInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::GetRoleCredentials, aws_http::retry::AwsErrorRetryPolicy>, aws_smithy_http::operation::BuildError> {
        let mut request = {
...
#[doc(hidden)] pub type ListAccountRolesInputOperationOutputAlias = crate::operation::ListAccountRoles;
            #[doc(hidden)] pub type ListAccountRolesInputOperationRetryAlias = aws_http::retry::AwsErrorRetryPolicy;
impl ListAccountRolesInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::ListAccountRoles, aws_http::retry::AwsErrorRetryPolicy>, aws_smithy_http::operation::BuildError> {
        let mut request = {
...
#[doc(hidden)] pub type ListAccountsInputOperationOutputAlias = crate::operation::ListAccounts;
            #[doc(hidden)] pub type ListAccountsInputOperationRetryAlias = aws_http::retry::AwsErrorRetryPolicy;
impl ListAccountsInput {
    /// Consumes the builder and constructs an Operation<[`ListAccounts`](crate::operation::ListAccounts)>
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::ListAccounts, aws_http::retry::AwsErrorRetryPolicy>, aws_smithy_http::operation::BuildError> {
        let mut request = {
...
#[doc(hidden)] pub type LogoutInputOperationOutputAlias = crate::operation::Logout;
            #[doc(hidden)] pub type LogoutInputOperationRetryAlias = aws_http::retry::AwsErrorRetryPolicy;
impl LogoutInput {
    /// Consumes the builder and constructs an Operation<[`Logout`](crate::operation::Logout)>
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::Logout, aws_http::retry::AwsErrorRetryPolicy>, aws_smithy_http::operation::BuildError> {
        let mut request = {
