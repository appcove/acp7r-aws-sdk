...
impl Builder {
    ...
    /// Set the timeout_config for the builder
                        ...
                        /// ```
                        pub fn set_timeout_config(&mut self, timeout_config: Option<aws_smithy_types::timeout::Config>) -> &mut Self {
    ...
    pub fn build(self) -> Config {
        Config {
            ...
            endpoint_resolver: self.endpoint_resolver.unwrap_or_else(||
                                    ::std::sync::Arc::new(crate::aws_endpoint::endpoint_resolver())
                                ),
            region: self.region,
