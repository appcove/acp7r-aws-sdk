...
impl  std::fmt::Debug for HealthCheck  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("cloud_watch_alarm_configuration", &self.cloud_watch_alarm_configuration);
        formatter.finish()
    }
}
...
impl  std::fmt::Debug for ResourceRecordSet  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("traffic_policy_instance_id", &self.traffic_policy_instance_id);
...
impl ResourceRecordSetRegion {
    ...
    pub fn values() -> &'static [&'static str] {
        &[
            "af-south-1", "ap-east-1", "ap-northeast-1", "ap-northeast-2", "ap-northeast-3", "ap-south-1", "ap-southeast-1", "ap-southeast-2", "ap-southeast-3", "ca-central-1", "cn-north-1", "cn-northwest-1", "eu-central-1", "eu-north-1", "eu-south-1", "eu-west-1", "eu-west-2", "eu-west-3", "me-south-1", "sa-east-1", "us-east-1", "us-east-2", "us-west-1", "us-west-2"
        ]
    }
}
...
impl  std::fmt::Debug for KeySigningKey  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("signing_algorithm_mnemonic", &self.signing_algorithm_mnemonic);
