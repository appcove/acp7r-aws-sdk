...
pub mod assume_role_input {
    ...
    pub struct Builder {
        ...
        pub(crate) policy_arns: std::option::Option<std::vec::Vec<crate::model::PolicyDescriptorType>>,
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::AssumeRoleInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
#[doc(hidden)] pub type AssumeRoleInputOperationOutputAlias = crate::operation::AssumeRole;
            #[doc(hidden)] pub type AssumeRoleInputOperationRetryAlias = aws_http::retry::AwsErrorRetryPolicy;
impl AssumeRoleInput {
    /// Consumes the builder and constructs an Operation<[`AssumeRole`](crate::operation::AssumeRole)>
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::AssumeRole, aws_http::retry::AwsErrorRetryPolicy>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::AssumeRoleInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::AssumeRole::new())
...
pub mod assume_role_with_saml_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::AssumeRoleWithSamlInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
#[doc(hidden)] pub type AssumeRoleWithSamlInputOperationOutputAlias = crate::operation::AssumeRoleWithSAML;
            #[doc(hidden)] pub type AssumeRoleWithSamlInputOperationRetryAlias = aws_http::retry::AwsErrorRetryPolicy;
impl AssumeRoleWithSamlInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::AssumeRoleWithSAML, aws_http::retry::AwsErrorRetryPolicy>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::AssumeRoleWithSamlInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
        ...
        aws_http::auth::set_provider(&mut request.properties_mut(), _config.credentials_provider.clone());
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::AssumeRoleWithSAML::new())
...
pub mod assume_role_with_web_identity_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::AssumeRoleWithWebIdentityInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
#[doc(hidden)] pub type AssumeRoleWithWebIdentityInputOperationOutputAlias = crate::operation::AssumeRoleWithWebIdentity;
            #[doc(hidden)] pub type AssumeRoleWithWebIdentityInputOperationRetryAlias = aws_http::retry::AwsErrorRetryPolicy;
impl AssumeRoleWithWebIdentityInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::AssumeRoleWithWebIdentity, aws_http::retry::AwsErrorRetryPolicy>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::AssumeRoleWithWebIdentityInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
        ...
        aws_http::auth::set_provider(&mut request.properties_mut(), _config.credentials_provider.clone());
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::AssumeRoleWithWebIdentity::new())
...
pub mod decode_authorization_message_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::DecodeAuthorizationMessageInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
#[doc(hidden)] pub type DecodeAuthorizationMessageInputOperationOutputAlias = crate::operation::DecodeAuthorizationMessage;
            #[doc(hidden)] pub type DecodeAuthorizationMessageInputOperationRetryAlias = aws_http::retry::AwsErrorRetryPolicy;
impl DecodeAuthorizationMessageInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DecodeAuthorizationMessage, aws_http::retry::AwsErrorRetryPolicy>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::DecodeAuthorizationMessageInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
        ...
        let mut properties = aws_smithy_http::property_bag::SharedPropertyBag::new();
        #[allow(clippy::useless_conversion)]let body = aws_smithy_http::body::SdkBody::from(
            crate::operation_ser::serialize_operation_crate_operation_decode_authorization_message(&self)?
        );
        if let Some(content_length) = body.content_length() {
                                request = aws_smithy_http::header::set_request_header_if_absent(request, http::header::CONTENT_LENGTH, content_length);
                            }
        ...
        aws_http::auth::set_provider(&mut request.properties_mut(), _config.credentials_provider.clone());
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::DecodeAuthorizationMessage::new())
...
pub mod get_access_key_info_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::GetAccessKeyInfoInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
#[doc(hidden)] pub type GetAccessKeyInfoInputOperationOutputAlias = crate::operation::GetAccessKeyInfo;
            #[doc(hidden)] pub type GetAccessKeyInfoInputOperationRetryAlias = aws_http::retry::AwsErrorRetryPolicy;
impl GetAccessKeyInfoInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::GetAccessKeyInfo, aws_http::retry::AwsErrorRetryPolicy>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::GetAccessKeyInfoInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
        ...
        aws_http::auth::set_provider(&mut request.properties_mut(), _config.credentials_provider.clone());
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::GetAccessKeyInfo::new())
...
pub mod get_caller_identity_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::GetCallerIdentityInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
#[doc(hidden)] pub type GetCallerIdentityInputOperationOutputAlias = crate::operation::GetCallerIdentity;
            #[doc(hidden)] pub type GetCallerIdentityInputOperationRetryAlias = aws_http::retry::AwsErrorRetryPolicy;
impl GetCallerIdentityInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::GetCallerIdentity, aws_http::retry::AwsErrorRetryPolicy>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::GetCallerIdentityInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
        ...
        aws_http::auth::set_provider(&mut request.properties_mut(), _config.credentials_provider.clone());
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::GetCallerIdentity::new())
...
pub mod get_federation_token_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::GetFederationTokenInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
#[doc(hidden)] pub type GetFederationTokenInputOperationOutputAlias = crate::operation::GetFederationToken;
            #[doc(hidden)] pub type GetFederationTokenInputOperationRetryAlias = aws_http::retry::AwsErrorRetryPolicy;
impl GetFederationTokenInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::GetFederationToken, aws_http::retry::AwsErrorRetryPolicy>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::GetFederationTokenInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
        ...
        aws_http::auth::set_provider(&mut request.properties_mut(), _config.credentials_provider.clone());
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::GetFederationToken::new())
...
pub mod get_session_token_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::GetSessionTokenInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
#[doc(hidden)] pub type GetSessionTokenInputOperationOutputAlias = crate::operation::GetSessionToken;
            #[doc(hidden)] pub type GetSessionTokenInputOperationRetryAlias = aws_http::retry::AwsErrorRetryPolicy;
impl GetSessionTokenInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::GetSessionToken, aws_http::retry::AwsErrorRetryPolicy>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::GetSessionTokenInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
        ...
        aws_http::auth::set_provider(&mut request.properties_mut(), _config.credentials_provider.clone());
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::GetSessionToken::new())
