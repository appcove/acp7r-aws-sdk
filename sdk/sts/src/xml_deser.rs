...
#[allow(unused_mut)]pub fn deser_structure_crate_error_expired_token_exception_xml_err(inp: &[u8], mut builder: crate::error::expired_token_exception::Builder) -> Result<crate::error::expired_token_exception::Builder, aws_smithy_xml::decode::XmlError> {
...
#[allow(unused_mut)]pub fn deser_structure_crate_error_malformed_policy_document_exception_xml_err(inp: &[u8], mut builder: crate::error::malformed_policy_document_exception::Builder) -> Result<crate::error::malformed_policy_document_exception::Builder, aws_smithy_xml::decode::XmlError> {
    if inp.is_empty() { return Ok(builder) }
    let mut document = aws_smithy_xml::decode::Document::try_from(inp)?;
                            #[allow(unused_mut)]
                            let mut error_decoder = crate::rest_xml_wrapped_errors::error_scope(&mut document)?;
...
#[allow(unused_mut)]pub fn deser_structure_crate_error_packed_policy_too_large_exception_xml_err(inp: &[u8], mut builder: crate::error::packed_policy_too_large_exception::Builder) -> Result<crate::error::packed_policy_too_large_exception::Builder, aws_smithy_xml::decode::XmlError> {
    if inp.is_empty() { return Ok(builder) }
    let mut document = aws_smithy_xml::decode::Document::try_from(inp)?;
                            #[allow(unused_mut)]
                            let mut error_decoder = crate::rest_xml_wrapped_errors::error_scope(&mut document)?;
...
#[allow(unused_mut)]pub fn deser_structure_crate_error_region_disabled_exception_xml_err(inp: &[u8], mut builder: crate::error::region_disabled_exception::Builder) -> Result<crate::error::region_disabled_exception::Builder, aws_smithy_xml::decode::XmlError> {
    if inp.is_empty() { return Ok(builder) }
    let mut document = aws_smithy_xml::decode::Document::try_from(inp)?;
                            #[allow(unused_mut)]
                            let mut error_decoder = crate::rest_xml_wrapped_errors::error_scope(&mut document)?;
...
#[allow(unused_mut)]pub fn deser_operation_crate_operation_assume_role(inp: &[u8], mut builder: crate::output::assume_role_output::Builder) -> Result<crate::output::assume_role_output::Builder, aws_smithy_xml::decode::XmlError> {
    ...
    if !(start_el.matches("AssumeRoleResponse")) {
                        return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid root, expected AssumeRoleResponse got {:?}", start_el)))
                    }
                    if let Some(mut result_tag) = decoder.next_tag() {
                        let start_el = result_tag.start_el();
                        if !(start_el.matches("AssumeRoleResult")) {
                            return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid result, expected AssumeRoleResult got {:?}", start_el)))
                        }
    while let Some(mut tag) = result_tag.next_tag() {
        match tag.start_el() {
            ...
            _ => {}
                        ...
                        return Err(aws_smithy_xml::decode::XmlError::custom("expected AssumeRoleResult tag"))
                    };
    Ok(builder)
}

#[allow(unused_mut)]pub fn deser_structure_crate_error_idp_rejected_claim_exception_xml_err(inp: &[u8], mut builder: crate::error::idp_rejected_claim_exception::Builder) -> Result<crate::error::idp_rejected_claim_exception::Builder, aws_smithy_xml::decode::XmlError> {
    if inp.is_empty() { return Ok(builder) }
    let mut document = aws_smithy_xml::decode::Document::try_from(inp)?;
                            #[allow(unused_mut)]
                            let mut error_decoder = crate::rest_xml_wrapped_errors::error_scope(&mut document)?;
...
#[allow(unused_mut)]pub fn deser_structure_crate_error_invalid_identity_token_exception_xml_err(inp: &[u8], mut builder: crate::error::invalid_identity_token_exception::Builder) -> Result<crate::error::invalid_identity_token_exception::Builder, aws_smithy_xml::decode::XmlError> {
    if inp.is_empty() { return Ok(builder) }
    let mut document = aws_smithy_xml::decode::Document::try_from(inp)?;
                            #[allow(unused_mut)]
                            let mut error_decoder = crate::rest_xml_wrapped_errors::error_scope(&mut document)?;
...
#[allow(unused_mut)]pub fn deser_operation_crate_operation_assume_role_with_saml(inp: &[u8], mut builder: crate::output::assume_role_with_saml_output::Builder) -> Result<crate::output::assume_role_with_saml_output::Builder, aws_smithy_xml::decode::XmlError> {
    let mut doc = aws_smithy_xml::decode::Document::try_from(inp)?;
    ...
    if !(start_el.matches("AssumeRoleWithSAMLResponse")) {
                        return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid root, expected AssumeRoleWithSAMLResponse got {:?}", start_el)))
                    }
                    if let Some(mut result_tag) = decoder.next_tag() {
                        let start_el = result_tag.start_el();
                        if !(start_el.matches("AssumeRoleWithSAMLResult")) {
                            return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid result, expected AssumeRoleWithSAMLResult got {:?}", start_el)))
                        }
    while let Some(mut tag) = result_tag.next_tag() {
        match tag.start_el() {
            ...
            _ => {}
                        ...
                        return Err(aws_smithy_xml::decode::XmlError::custom("expected AssumeRoleWithSAMLResult tag"))
                    };
    Ok(builder)
}

#[allow(unused_mut)]pub fn deser_structure_crate_error_idp_communication_error_exception_xml_err(inp: &[u8], mut builder: crate::error::idp_communication_error_exception::Builder) -> Result<crate::error::idp_communication_error_exception::Builder, aws_smithy_xml::decode::XmlError> {
    if inp.is_empty() { return Ok(builder) }
    let mut document = aws_smithy_xml::decode::Document::try_from(inp)?;
                            #[allow(unused_mut)]
                            let mut error_decoder = crate::rest_xml_wrapped_errors::error_scope(&mut document)?;
...
#[allow(unused_mut)]pub fn deser_operation_crate_operation_assume_role_with_web_identity(inp: &[u8], mut builder: crate::output::assume_role_with_web_identity_output::Builder) -> Result<crate::output::assume_role_with_web_identity_output::Builder, aws_smithy_xml::decode::XmlError> {
    let mut doc = aws_smithy_xml::decode::Document::try_from(inp)?;
    ...
    if !(start_el.matches("AssumeRoleWithWebIdentityResponse")) {
                        return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid root, expected AssumeRoleWithWebIdentityResponse got {:?}", start_el)))
                    }
                    if let Some(mut result_tag) = decoder.next_tag() {
                        let start_el = result_tag.start_el();
                        if !(start_el.matches("AssumeRoleWithWebIdentityResult")) {
                            return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid result, expected AssumeRoleWithWebIdentityResult got {:?}", start_el)))
                        }
    while let Some(mut tag) = result_tag.next_tag() {
        match tag.start_el() {
            ...
            _ => {}
                        ...
                        return Err(aws_smithy_xml::decode::XmlError::custom("expected AssumeRoleWithWebIdentityResult tag"))
                    };
    Ok(builder)
}

#[allow(unused_mut)]pub fn deser_structure_crate_error_invalid_authorization_message_exception_xml_err(inp: &[u8], mut builder: crate::error::invalid_authorization_message_exception::Builder) -> Result<crate::error::invalid_authorization_message_exception::Builder, aws_smithy_xml::decode::XmlError> {
    if inp.is_empty() { return Ok(builder) }
    let mut document = aws_smithy_xml::decode::Document::try_from(inp)?;
                            #[allow(unused_mut)]
                            let mut error_decoder = crate::rest_xml_wrapped_errors::error_scope(&mut document)?;
...
#[allow(unused_mut)]pub fn deser_operation_crate_operation_decode_authorization_message(inp: &[u8], mut builder: crate::output::decode_authorization_message_output::Builder) -> Result<crate::output::decode_authorization_message_output::Builder, aws_smithy_xml::decode::XmlError> {
    let mut doc = aws_smithy_xml::decode::Document::try_from(inp)?;
    ...
    if !(start_el.matches("DecodeAuthorizationMessageResponse")) {
                        return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid root, expected DecodeAuthorizationMessageResponse got {:?}", start_el)))
                    }
                    if let Some(mut result_tag) = decoder.next_tag() {
                        let start_el = result_tag.start_el();
                        if !(start_el.matches("DecodeAuthorizationMessageResult")) {
                            return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid result, expected DecodeAuthorizationMessageResult got {:?}", start_el)))
                        }
    while let Some(mut tag) = result_tag.next_tag() {
        match tag.start_el() {
            ...
            _ => {}
                        ...
                        return Err(aws_smithy_xml::decode::XmlError::custom("expected DecodeAuthorizationMessageResult tag"))
                    };
    Ok(builder)
}

#[allow(unused_mut)]pub fn deser_operation_crate_operation_get_access_key_info(inp: &[u8], mut builder: crate::output::get_access_key_info_output::Builder) -> Result<crate::output::get_access_key_info_output::Builder, aws_smithy_xml::decode::XmlError> {
    let mut doc = aws_smithy_xml::decode::Document::try_from(inp)?;
    ...
    if !(start_el.matches("GetAccessKeyInfoResponse")) {
                        return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid root, expected GetAccessKeyInfoResponse got {:?}", start_el)))
                    }
                    if let Some(mut result_tag) = decoder.next_tag() {
                        let start_el = result_tag.start_el();
                        if !(start_el.matches("GetAccessKeyInfoResult")) {
                            return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid result, expected GetAccessKeyInfoResult got {:?}", start_el)))
                        }
    while let Some(mut tag) = result_tag.next_tag() {
        match tag.start_el() {
            ...
            _ => {}
                        ...
                        return Err(aws_smithy_xml::decode::XmlError::custom("expected GetAccessKeyInfoResult tag"))
                    };
    Ok(builder)
}

#[allow(unused_mut)]pub fn deser_operation_crate_operation_get_caller_identity(inp: &[u8], mut builder: crate::output::get_caller_identity_output::Builder) -> Result<crate::output::get_caller_identity_output::Builder, aws_smithy_xml::decode::XmlError> {
    let mut doc = aws_smithy_xml::decode::Document::try_from(inp)?;
    ...
    if !(start_el.matches("GetCallerIdentityResponse")) {
                        return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid root, expected GetCallerIdentityResponse got {:?}", start_el)))
                    }
                    if let Some(mut result_tag) = decoder.next_tag() {
                        let start_el = result_tag.start_el();
                        if !(start_el.matches("GetCallerIdentityResult")) {
                            return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid result, expected GetCallerIdentityResult got {:?}", start_el)))
                        }
    while let Some(mut tag) = result_tag.next_tag() {
        match tag.start_el() {
            ...
            _ => {}
                        ...
                        return Err(aws_smithy_xml::decode::XmlError::custom("expected GetCallerIdentityResult tag"))
                    };
    Ok(builder)
}

#[allow(unused_mut)]pub fn deser_operation_crate_operation_get_federation_token(inp: &[u8], mut builder: crate::output::get_federation_token_output::Builder) -> Result<crate::output::get_federation_token_output::Builder, aws_smithy_xml::decode::XmlError> {
    let mut doc = aws_smithy_xml::decode::Document::try_from(inp)?;
    ...
    if !(start_el.matches("GetFederationTokenResponse")) {
                        return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid root, expected GetFederationTokenResponse got {:?}", start_el)))
                    }
                    if let Some(mut result_tag) = decoder.next_tag() {
                        let start_el = result_tag.start_el();
                        if !(start_el.matches("GetFederationTokenResult")) {
                            return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid result, expected GetFederationTokenResult got {:?}", start_el)))
                        }
    while let Some(mut tag) = result_tag.next_tag() {
        match tag.start_el() {
            ...
            _ => {}
                        ...
                        return Err(aws_smithy_xml::decode::XmlError::custom("expected GetFederationTokenResult tag"))
                    };
    Ok(builder)
}

#[allow(unused_mut)]pub fn deser_operation_crate_operation_get_session_token(inp: &[u8], mut builder: crate::output::get_session_token_output::Builder) -> Result<crate::output::get_session_token_output::Builder, aws_smithy_xml::decode::XmlError> {
    let mut doc = aws_smithy_xml::decode::Document::try_from(inp)?;
    ...
    if !(start_el.matches("GetSessionTokenResponse")) {
                        return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid root, expected GetSessionTokenResponse got {:?}", start_el)))
                    }
                    if let Some(mut result_tag) = decoder.next_tag() {
                        let start_el = result_tag.start_el();
                        if !(start_el.matches("GetSessionTokenResult")) {
                            return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid result, expected GetSessionTokenResult got {:?}", start_el)))
                        }
    while let Some(mut tag) = result_tag.next_tag() {
        match tag.start_el() {
            ...
            _ => {}
                        ...
                        return Err(aws_smithy_xml::decode::XmlError::custom("expected GetSessionTokenResult tag"))
                    };
    Ok(builder)
}

pub fn deser_structure_crate_model_credentials(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::Credentials, aws_smithy_xml::decode::XmlError> {
...
pub fn deser_structure_crate_model_assumed_role_user(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::AssumedRoleUser, aws_smithy_xml::decode::XmlError> {
    #[allow(unused_mut)]let mut builder = crate::model::AssumedRoleUser::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
...
pub fn deser_structure_crate_model_federated_user(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::FederatedUser, aws_smithy_xml::decode::XmlError> {
    #[allow(unused_mut)]let mut builder = crate::model::FederatedUser::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
